	...
	properties: [
		...
		},
		{
			...
			options: [
				...
				{
					name: 'Customer Subsidiary Relationship',
				...
				{ name: 'Advanced Intercompany Journal Entry', value: 'advIntercompanyJournalEntry' },
		...
		},
		{
			...
			description:
				'The internal identifier of the Custom Record type. These normally start with customrecord',
		},
		{
			displayName: 'ID',
			name: 'internalId',
			...
			displayOptions: {
				show: {
					operation: ['getRecord', 'updateRecord', 'removeRecord'],
				},
			},
			description:
				'The internal identifier of the record. Prefix with eid: to use the external identifier.',
		},
		{
			displayName: 'Query',
			name: 'query',
			...
			displayOptions: {
				show: {
					operation: ['listRecords', 'runSuiteQL'],
				},
			},
		},
		{
		...
		},
		{
			...
			description:
				'Optionally return only the specified fields and sublists in the response.',
		},
		{
		...
		},
		{
			...
			description:
				'If true, all fields that should be deleted in the update request, including body fields, must be included in the replace query parameter.',
		},
		{
			...
			description:
				'If true, automatically expands all sublists, sublist lines, and subrecords on this record.',
		},
		{
			...
			description:
				'If true, returns enumeration values in a format that only shows the internal ID value.',
		},
		{
			...
			default: false,
			description:
				'Whether all results should be returned or only up to a given limit',
		},
		{
			displayName: 'Limit',
			name: 'limit',
			...
			options: [
				{
					...
					description:
						'Use control the maximum number of REST requests sent to NetSuite at the same time. The default is 1.',
				},
				{
